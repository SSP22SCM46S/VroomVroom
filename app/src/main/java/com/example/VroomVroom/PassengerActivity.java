        ...
        carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                ...
                if (objects.size() > 0 && e == null) {
                    ...
                    isVroomVroomCancelled = false;
                    btnRequestCar.setText("Cancel your VroomVroom request!");
                    ...
                    requestCar.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                btnRequestCar.setText("Cancel your VroomVroom order");
                                isVroomVroomCancelled = false;
            ...
            carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> requestList, ParseException e) {
                    ...
                    if (requestList.size() > 0 && e == null) {
                        ...
                        isVroomVroomCancelled = true;
                        btnRequestCar.setText("Request a new VroomVroom");

                        for (ParseObject VroomVroomRequest : requestList ) {

                            VroomVroomRequest.deleteInBackground(new DeleteCallback() {
                                @Override
                                public void done(ParseException e) {
    ...
    private void getDriverUpdates() {
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                ParseQuery<ParseObject> VroomVroomRequestQuery = ParseQuery.getQuery("RequestCar");
                VroomVroomRequestQuery.whereEqualTo("username",ParseUser.getCurrentUser().getUsername());
                VroomVroomRequestQuery.whereEqualTo("requestAccepted",true);
                VroomVroomRequestQuery.whereExists("driverOfMe");

                VroomVroomRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                    @Override
                                                        ...
                                                        requestObject.deleteInBackground(new DeleteCallback() {
                                                            ...
                                                            public void done(ParseException e) {
                                                                if ( e == null ) {
                                                                    ...
                                                                    Toast.makeText(PassengerActivity.this, "Your VroomVroom is ready! Hurray", Toast.LENGTH_LONG).show();
                                                                    isCarReady = false;
                                                                    isVroomVroomCancelled = true;
                                                                    btnRequestCar.setText("You can order a new VroomVroom now!");
